...
dependencies {
    ...
    implementation ("org.springframework.boot:spring-boot-starter-web:2.7.18") // Upgraded to mitigate CVE-2022-22965 (Spring4Shell) and get latest security patches
